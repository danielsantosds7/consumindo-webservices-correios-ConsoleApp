...
namespace WebServicesCorreios
{
    internal class Program
    {
        ...
        {
            // C# - Localizando CEP
            Console.WriteLine("***LOCALIZANDO CEP***");
            Console.WriteLine();            
            ...
            try
            {
                ...
                System.Console.Write("Unidades de Postagem: {0}", resposta.unidadesPostagem);
            }
            catch (Exception ex)
            {
            ...
            // C# - Calculando preço e prazo de uma encomenda SEDEX ou PAC
            Console.WriteLine("***CALCULANDO PREÇO E PRAZO DE UMA ENCOMENDA SEDEX OU PAC***");
            Console.WriteLine();            
